...
//********** VALIDACIONES ********** */
  ...
  const validacionesRegistro = [
    body('nombreApellido').isLength({
      min: 1
    }).withMessage('El campo Nombre y Apellido no puede estar vacío'),
  ...
  body('image-users').custom((value, {req}) =>{
...
router.post('/register', upload.single('image-users'),validacionesRegistro, usersController.create);
